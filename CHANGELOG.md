...
- A small offset to the bounding box clipping in the rpn.py file to resolve potential conflicts during ROI alignment.
...
- Testing of the bilinear interpolation in the alignments.ipynb file.
