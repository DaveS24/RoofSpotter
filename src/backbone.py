...
class Backbone:
    def __init__(self, input_shape, trainable_layers, name='Backbone'):
    ...
    def build_model(self):
        ...
        resnet50 = tf.keras.applications.ResNet50(weights='imagenet', include_top=False, input_shape=self.input_shape)
